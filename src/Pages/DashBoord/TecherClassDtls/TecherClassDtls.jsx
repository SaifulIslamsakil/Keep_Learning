...
import TecherDtlsNavBar from "./TecherDtlsNavBar";

const TecherClassDtls = () => {
    const data = useLoaderData()
    console.log(data)
    return (
        <div className="">
            <TecherDtlsNavBar id={data?._id} ></TecherDtlsNavBar> 
            <div className="  gap-4 w-11/12 p-5 mx-auto my-3">
                <div className="  ">
                    <div className=" space-y-3">
                        <img className=" h-96 object-cover w-full" src={data.img} alt="" />
                        <p className=" text-2xl font-semibold">{data.Experince}</p>
                        <h3 className=" text-4xl font-bold border-l-4 border-green-500 px-4">{data.title}</h3>
...
export default TecherClassDtls;