...
import StudentNabBar from "./StudentNabBar";


const StudentClassDtls = () => {
    const studentData = useLoaderData()
    console.log(studentData)
    return (
        <div className="">
            <StudentNabBar coruse_id={studentData?.crouse_id}></StudentNabBar>
            <div className="  gap-4 h-3/4 p-5 mx-auto my-3">
            <div className=" ">
                <div className=" space-y-5">
                <img className=" w-full h-96 object-cover" src={studentData?.img} alt="" />
                    <h3 className=" text-4xl mt-4  font-bold border-l-4 border-green-500 px-4">{studentData.title}</h3>
...
export default StudentClassDtls;